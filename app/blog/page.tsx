...
export default function BlogPage() {
  ...
  const blogPosts = [
    ...
    { id: 2, title: 'Building Your First Startup', excerpt: 'Lessons from founding TIQ World and scaling to 50+ enterprise clients. What worked, what failed, and what I wish I knew.', date: 'Mar 8, 2024', category: 'Entrepreneurship', emoji: '🚀', readTime: '7 min', featured: false },
    { id: 3, title: 'Speaking at Tech Conferences', excerpt: 'Tips for crafting memorable keynotes and engaging technical audiences without dumbing down the content.', date: 'Feb 28, 2024', category: 'Speaking', emoji: '🎤', readTime: '4 min', featured: false },
    { id: 4, title: 'Python for NDT Data Analysis', excerpt: 'Practical guide to processing ultrasonic and radiographic data with Python, NumPy, and PyTorch.', date: 'Feb 14, 2024', category: 'AI & ML', emoji: '🐍', readTime: '8 min', featured: false },
    { id: 5, title: 'Manufacturing 4.0 in India', excerpt: 'How Indian manufacturers can leapfrog into Industry 4.0 with AI — the talent, the infrastructure, and the policy gaps.', date: 'Jan 30, 2024', category: 'Research', emoji: '🏭', readTime: '6 min', featured: false },
    { id: 6, title: 'From Engineer to Entrepreneur', excerpt: 'The mindset shift required when you stop building for others and start building for yourself. Hard-won lessons.', date: 'Jan 15, 2024', category: 'Entrepreneurship', emoji: '💡', readTime: '5 min', featured: false },
  ];
